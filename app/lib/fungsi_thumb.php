...
function UploadImage($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../gambar/foto_berita/";
...
function UploadFotoLokasi($fupload_name){
  //direktori gambar
  $vdir_upload = "../gambar/foto_lokasi/";
  $vfile_upload = $vdir_upload . $fupload_name;

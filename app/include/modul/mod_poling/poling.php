...
switch($_GET[act]){
  ...
  default:
    ...
    $body.="<tr><td>$r[survie]</td>
          <td xalign=center><a href=?page=polling&act=editsurvei&id=$r[id_surv]>Ganti</a></td></tr>";
	      }
	$body.="</table>";
	
    $body.="<h2>Manage Pilihan</h2>
          <input type=button class='btn btn-primary' value='Tambah Poling' onclick=\"window.location.href='?page=polling&act=tambahpoling';\">
          <table class='table'>
    ...
    while ($r=mysql_fetch_array($tampil)){
      $body.="<tr>
            ...
            <td>$r[pilihan]</td>
            <td xalign=center>$r[rating]</td>
            <td xalign=center>$r[aktif]</td>
            <td xalign=center><a href=?page=polling&act=editpoling&id=$r[id_poling]>Edit</a> | 
  ...
  case "tambahpoling":
    $body.="<h2>Tambah Poling</h2>
          ...
          <table class='table'>
          <tr><td>Pilihan</td> <td><input type=text class='form-control' name='pilihan'></td></tr>
  ...
  case "editpoling":
    ...
    $body.="<h2>Edit Poling</h2>
          ...
          <table class='table'>
          <tr><td>Pilihan</td> <td><input class='form-control' type=text name='pilihan' value='$r[pilihan]'></td></tr>";
    if ($r[aktif]=='Y'){
    ...
    $body.="<tr><td colspan=2><input type=submit class='btn btn-primary' value=Update>
                            <input type=button value=Batal class='btn btn-danger' onclick=self.history.back()></td></tr>
          </table></form>";
    break;  
    ...
    $body.="<h2>Ganti Pertanyaan</h2>
          ...
          <table class='table'>
          <tr><td>Pertanyaan Polling</td><td><input class='form-control' style=width:350px; type=text name='survei' value='$s[survie]'></td></tr>
          <tr><td></td><td><input type=submit value=Ganti class='btn btn-danger' >
                            <input type=button value=Batal class='btn btn-primary' onclick=self.history.back()></td></tr>
          </table></form>";
    break;  
}
?>

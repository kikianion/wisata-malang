...
switch ($_GET[act]) {
  ...
  default:
    $body .= "<h2>Manage Penginapan</h2>
          <div class='btn-group'>
          <input type=button class='btn btn-primary' value='Tambah Objek Penginapan' onclick=\"window.location.href='?page=man_penginapan&act=tambahpenginapan';\">
		  <input type=button class='btn btn-primary' value='Tambah Foto Penginapan' onclick=\"window.location.href='?page=add_foto_penginapan';\">
          </div>
  ...
  case "foto":
    ...
    $body .= "<tr><td><a class='btn btn-warning' href='page_admin.php?page=man_penginapan'>Kembali</a></td></tr></table>";
    break;
  case "hapus":
    $id = $_GET['id'];
  ...
  case "tambahpenginapan":
    ...
    $body .= "<h2>Tambah Penginapan</h2>
          ...
          <table class='table'>
          <tr><td width=70>Nama</td>     <td>  <input class='form-control' type=text name='nama' size=60 value=''></td></tr>";



    $body .= "
          <tr><td width=70>Alamat</td>     <td>  <input  class='form-control'  type=text name='alamat' size=60 value=''></td></tr>
		  <tr><td width=70>Telepon</td>     <td>  <input  class='form-control' type=text name='telpon' size=60 value=''></td></tr>
		  <tr><td>Keterangan</td>  <td> <textarea name='keterangan'  class='form-control' style='width: 450px; height: 100px;'></textarea></td></tr>
         ";

    $body .= "<tr><td colspan=2><input type=submit value=Add class='btn btn-primary'>
  ...
  case "editpenginapan":
    ...
    $body .= "<h2>Edit Penginapan</h2>
          ...
          <table  class='table'>
          <tr><td width=70>Nama</td>     <td>  <input class='form-control' type=text name='nama' size=60 value='$r[nama]'></td></tr>";



    $body .= "
          <tr><td width=70>Alamat</td>     <td>  <input class='form-control' type=text name='alamat' size=60 value='$r[alamat]'></td></tr>
		  <tr><td width=70>Telepon</td>     <td>  <input type=text class='form-control' name='telpon' size=60 value='$r[telpon]'></td></tr>
		  <tr><td>Keterangan</td>  <td> <textarea name='keterangan' class='form-control' style='width: 450px; height: 100px;'>$r[keterangan]</textarea></td></tr>

...
switch ($_GET[act]) {
  default:
    ...
    $body .= "Pilih Wisata: <select name=wisata class='form-control'>";
    while ($d = mysql_fetch_array($m)) {
      $body .= "<option value=$d[nama]>$d[nama]</option>";
    }
    $body .= "</select><br />
Pilih File Gambar: <input name='userfile'  class='form-control' type='file' /><br />
<input type='submit' value='Upload' class='btn btn-primary'/>&nbsp;
<a class='btn btn-warning' href='page_admin.php?page=man_wisata'>Kembali</a>
</form> ";
    break;
  case "aksi":
